export let queries = {
  queryBuilder: {
    ...
    insert                : "insert into `todo` as `t` (`done`, `task`) values (true, 'Bake cake')",
    insertTransformed     : "insert into `transformtodo` as `t` (`done`, `id`, `task`) values (true, 'uuidplaceholder', 'Bake cake')",
    update                : "update `todo` set `done` = true where `id` = 1",
    updateTransformed     : "update `transformtodo` set `done` = true, `task` = 'Bake awesome cake' where `id` = 'uuidplaceholder'",
    ...
    deleteByIdTransformed : "delete from `transformtodo` where `id` = 1",
